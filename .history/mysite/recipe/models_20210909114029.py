...
class Recipe(models.Model):
    ...
    def _check_if_name_exists(self, name: str):
    ...
    def _delete_old_photos(self, new_photos: list, old_photos: list):
    ...
    def get_recalculated_calories(self, number_of_portions):
