...
from users.selectors import get_strava_last_request_epoc_time, get_activities_from_strava,   process_and_save_strava_activities, prepare_strava_request_url
import datetime
...
def process_and_save_strava_activities(raw_strava_activities: list) -> None:
    ...
    if raw_strava_activities and isinstance(raw_strava_activities, list):
        ...
        for activity in raw_strava_activities:
            ...
            header = selcreate_authorization_header()
