...
class HealthDiaryIntputSerializer(serializers.Serializer):
    """ preparing data for saving in db """

    weight = serializers.FloatField(min_value=20, max_value=300)
    sleep_length = serializers.TimeField()
    rest_hearth_rate = serializers.IntegerField(min_value=0, max_value=230)
